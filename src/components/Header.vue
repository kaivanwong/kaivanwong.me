...
<template>
  <header max-w-3xl mx-auto h-18 px-6 flex justify-between items-center relative>
    <nav
    ...
    <menu text-lg sm:hidden inline-block i-ri-menu-2-fill @click="toggleMenu" />
    <div text-lg flex gap-4 sm:gap-6>
