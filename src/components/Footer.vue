...
<template>
  <footer class="w-full mt-18 pt-6 pb-8 max-w-3xl text-sm flex flex-col gap-4 border-main border-t !border-op-50 text-dark dark:text-white">
    ...
    <div>
      <span op-70>Powered by </span>
      <a nav-link aria-label="Vitesse Theme for Astro" target="_blank" href="https://github.com/kaivanwong/vitesse-astro-theme">Vitesse Theme for Astro</a>
    </div>
  </footer>
</template>
